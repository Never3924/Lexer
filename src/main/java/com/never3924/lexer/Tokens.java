...
public class Tokens extends ArrayList<String>{
    ...
    /**
     * getStringCharIndex method
     * @param search Returns a list of elements enclosed by the specified Character
     * @return List of elements enclosed by the specified Character
     */
